...
<body>
    ...
    <a href="retrieve.php"><button id="update-btn">FIND PET</button></a>
    <a href="delete.php"><button>DELETE PET</button></a>
    <br><br>
    
    <form action="../php/retrieve.php" method="get">
        <h4>FIND PET IN THE DATABASE</h4>
        <div class="container2">
            <label for="findPet">Search Pet by ID, Name, Species, Weight, Ailment, Owner or Vet:</label>
            <input type="text" name="findPet" id="findPet" required>
    ...
    <?php
        if (isset($_GET['submit'])) {
            ...
            try {
                ...
                WHERE PetID = '$findPet' OR PetName = '$findPet' OR PetSpecies = '$findPet' OR 
                PetWeight = '$findPet' OR PetAilment = '$findPet' OR pet_owner.OwnerFirstName = '$findPet' 
                OR pet_owner.OwnerLastName = '$findPet' OR vet.VetFirstName = '$findPet' 
                OR vet.VetLastName = '$findPet'";
